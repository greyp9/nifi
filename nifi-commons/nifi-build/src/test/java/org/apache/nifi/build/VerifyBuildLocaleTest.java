...
public class VerifyBuildLocaleTest {
     ...
     *
     * While the environment variable JAVA_TOOLS_OPTIONS may be used to supply locale information to a Java process,
     * this test may also be used to verify the default system locale when JAVA_TOOLS_OPTIONS is not specified.
     */
