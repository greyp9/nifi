...
public class CoralCreateServlet extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
        ...
        doGetHtml(textUI, fileUI, request.getRequestURI(), response);
    }
    ...
    private void doGetHtml(final boolean textUI, final boolean fileUI,
                           final String requestURI, final HttpServletResponse response) throws IOException {
        final Document document = CoralUtils.create("html", new Attribute("lang", "en"));
        ...
        final Element formAttribute = CoralUtils.addChild(divFormAddAttribute, "form",
                new Attribute("action", requestURI), new Attribute("method", "post"));
        ...
        if (fileUI) {
            ...
            final Element formUpload = CoralUtils.addChild(divFormUpload, "form",
                    new Attribute("action", requestURI), new Attribute("method", "post"), new Attribute("enctype", "multipart/form-data"));
            CoralUtils.addChild(formUpload, "input", new Attribute("name", "uploadFile"), new Attribute("type", "file"));
            CoralUtils.addChild(formUpload, "input", new Attribute("name", "submitUploadFile"),
                    new Attribute("type", "submit"), new Attribute("value", "Upload Content"));
        }
        ...
        if (textUI) {
            ...
            CoralUtils.addChild(divFormEdit1, "textarea", content, new Attribute("placeholder", "enter text"),
                    new Attribute("rows", "12"), new Attribute("cols", "132"), new Attribute("name", "text"));
            final Element divFormEdit2 = CoralUtils.addChild(formEdit, "div");
            CoralUtils.addChild(divFormEdit2, "input", new Attribute("name", "updateText"),
                    new Attribute("type", "submit"), new Attribute("value", "Update Content"));
        }

        final Element divSubmit = CoralUtils.addChild(divContent, "div", new Attribute("id", "submit"));
